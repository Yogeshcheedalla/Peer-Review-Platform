...
const verifyAdminComments = async () => {
    try {
        ...
        const assignment = new Assignment({
            ...
            description: "Test",
            deadline: new Date(Date.now() - 86400000), // yesterday (so peer review is open)
            maxScore: 100,
        ...
        // 6. Simulate Admin Fetch
        // We can't easily simulate the express req/res here without mocking, 
        // but we can replicate the logic used in the endpoint.
