...
const Admin = () => {
    ...
    const [activeTab, setActiveTab] = useState("projects"); // projects, teachers
                                        ...
                                        {submissions.map((sub) => (
                                            <div key={sub._id} className="assignment-card">
                                                ...
                                                <div style={{ marginTop: "10px", fontWeight: "bold" }}>
                                                    Grade: {sub.grade !== undefined ? `${sub.grade}/${selectedAssignment.maxScore}` : <span style={{ color: "orange" }}>Not Graded</span>}
                                                </div>
